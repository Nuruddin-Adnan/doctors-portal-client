...
const ManageDoctors = () => {
    ...
    const { data: doctors = [], isLoading, refetch } = useQuery({
        queryKey: ['doctors'],
        queryFn: async () => {
            const res = await fetch('https://doctors-portal-server-nuruddin-adnan.vercel.app/doctors', {
                headers: {
    ...
    const handleDeleteDoctor = doctor => {
        fetch(`https://doctors-portal-server-nuruddin-adnan.vercel.app/doctors/${doctor._id}`, {
            method: 'DELETE',
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
